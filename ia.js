...
var niveauNappe = [ 0.5, 1.5, 1.75, 3, 2, 1.7, 1.2, 1.25, 0, 1.4, 10 ];

var humidite = [ 0, 30, 65, 81, 40, 55, 75, 60, 45, 50, 100 ];

var temperature = [ 0, 30, 65, 81, 40, 55, 75, 60, 45, 50, 100 ];

var arrosageThCourt = [ 0, 0, 0, 0.88, 0, 0, 0, 0.8, 0.75, 0.5, 0 ];

var arrosageThMoyen = [ 0, 0, 0.63, 0, 0.8, 0, 0.5, 0.2, 0, 0.13, 0 ];

var arrosageThLong = [ 1, 1, 0.38, 0, 0, 0.75, 0, 0, 0, 0, 0 ];

var dureeTheorique = [ 23.67, 23.67, 17.13, 3.74, 15.17, 23.28, 15.86, 9.1, 3.87, 9.39, 0 ];

var duree = [ 0, 15, 14.16, 3.74, 15.17, 17.34, 4.26, 4.5, 0, 4.5, 0 ];

var arrosageCourt = [ 0, 0, 0.5, 0.88, 0, 0, 0.4, 0.2, 0, 0.13, 0 ];

var arrosageMoyen = [ 0, 1, 0.5, 0, 0.8, 0.6, 0, 0, 0, 0, 0, 0 ];

var arrosageLong = [ 0, 0, 0.38, 0, 0, 0.4, 0, 0, 0, 0, 0 ];
